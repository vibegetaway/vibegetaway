...
export function SearchBar({ vibe, setVibe, onSearch, onSettingsClick }: SearchBarProps) {
    ...
    return (
        <div className="relative z-50 bg-white/95 backdrop-blur-sm rounded-2xl shadow-lg py-2 px-4 w-full md:w-auto">
            ...
            <div className="flex items-center gap-2 min-w-0 overflow-hidden">
                ...
                <h1 className="text-base font-bold leading-tight flex items-center gap-2 min-w-0 flex-1 overflow-hidden">
                    ...
                    <span className="inline-block align-middle relative min-w-0 flex-1 sm:flex-initial sm:w-[140px] md:w-[320px] sm:max-w-[180px] md:max-w-[320px]" style={{ maxWidth: onSettingsClick ? 'calc(100% - 200px)' : 'calc(100% - 160px)' }}>
                        <SmartTagInput
                            value={tags}
