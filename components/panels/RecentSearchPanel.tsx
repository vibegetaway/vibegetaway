...
export function RecentSearchPanel({ isOpen, onClose, onSearchSelect }: RecentSearchPanelProps) {
  ...
  return (
    <>
      ...
      <div
        className={`fixed left-20 top-0 h-screen w-full max-w-md bg-violet-50 border-r border-violet-200/50 shadow-2xl z-50 transition-transform duration-300 ease-in-out overflow-y-auto pointer-events-auto ${isOpen ? 'translate-x-0' : '-translate-x-full'
          }`}
      >
        ...
        <div className="p-6">
          ...
          <div className="flex items-start justify-between mb-6">
            <div>
              <h2 className="text-2xl font-bold text-violet-900 mb-1 tracking-tight">Recent Searches</h2>
              <p className="text-violet-500 text-xs font-medium">Your search history</p>
            </div>
