    ...
    <div className="md:hidden fixed bottom-6 left-0 right-0 z-50 pointer-events-none flex justify-center">
      <div className="pointer-events-auto bg-background/80 backdrop-blur-md border border-white/20 shadow-2xl rounded-full px-6 py-3 flex items-center gap-6 max-w-[90%] mx-4">
        ...
        <button
          ...
          className={`flex flex-col items-center gap-0.5 transition-all duration-200 active:scale-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded-lg ${activePage === 'home'
            ? 'text-primary'
        ...
        <button
          ...
          className={`flex flex-col items-center gap-0.5 transition-all duration-200 active:scale-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-secondary rounded-lg ${activePage === 'search'
            ? 'text-secondary'
            : 'text-muted-foreground hover:text-foreground'
            }`}
        >
        ...
        {!hidePlanButton && (
          <button
            ...
            className="flex flex-col items-center -mt-8 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded-full"
          >
        ...
        <button
          ...
          className={`flex flex-col items-center gap-0.5 transition-all duration-200 active:scale-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent rounded-lg ${activePage === 'itineraries'
            ? 'text-accent'
            : 'text-muted-foreground hover:text-foreground'
            }`}
        >
        ...
        <div className="flex flex-col items-center">
          {isSignedIn ? (
            ...
            <SignInButton mode="modal">
              <button
                aria-label="Sign in"
                className="flex flex-col items-center gap-0.5 text-muted-foreground hover:text-foreground transition-all duration-200 active:scale-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-secondary rounded-lg"
              >
